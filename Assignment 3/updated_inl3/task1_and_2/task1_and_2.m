...
disp("Own model:       " + "Face: " + predictions_test(indx_face) + ...
    "    Non-face:" + predictions_test(indx_not_face))
disp("Tree model:      " + "Face: " + predictions_test_tree(indx_face) + ...
    "    Non-face:" + predictions_test_tree(indx_not_face))
disp("SVM model:       " + "Face: " + predictions_test_svm(indx_face) + ...
    "    Non-face:" + predictions_test_svm(indx_not_face))
disp("NN model:        " + "Face: " + predictions_test_nn(indx_face) + ...
    "    Non-face:" + predictions_test_nn(indx_not_face))
